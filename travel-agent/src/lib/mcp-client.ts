 ...
 *
 * Used by the travel advisor to REPLY on social platforms (Twitter, Telegram,
 * Discord, Slack, WhatsApp). All outbound social communication goes through
 * social-mcp; the travel-agent never builds its own platform clients.
 *
...
export class SocialMCPClient {
  ...
  async connect(): Promise<void> {
    ...
    this.client = new Client(
      { name: 'nomadsage-travel-agent', version: '1.0.0' },
      { capabilities: {} }
    );
